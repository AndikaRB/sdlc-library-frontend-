...
const AdminDashboard = () => {
    ...
    const renderBooks = () => {
        return books.map((val) => {
            console.log(val)
            return (
                <Tr height={"200px"} border={'1px inset black'} borderRadius={'10%'}>
                    <Td>
        ...
        <>
            ...
            >
                ...
                <ModalContent>
                    ...
                    <ModalCloseButton />
                    <ModalBody>Lorem ipsum dolor sit amet consectetur adipisicing elit. Repellat, magni numquam! Fugiat, soluta repudiandae? Ducimus autem distinctio cumque dolor sapiente! Magnam sed qui facilis sint atque ipsam natus vitae obcaecati. Lorem, ipsum dolor sit amet consectetur adipisicing elit. Repellat recusandae maiores quaerat quo? Sint quibusdam saepe officiis ex id. Nisi hic eos porro delectus, ipsum sed adipisci quasi nam doloremque.</ModalBody>
